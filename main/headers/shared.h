...
enum lcd_index {
	...
	LCD_INDEX__SWAP_TO_OPTION,
	LCD_INDEX__SWAP_TO_BUTTON_A,
	LCD_INDEX__SWAP_TO_BUTTON_B,
	LCD_INDEX__END,
};
...
enum lcd_icon {
	...
	LCD_ICON__SWAP_TO_OPTION_OFF,
	LCD_ICON__SWAP_TO_OPTION_ON,
	LCD_ICON__SWAP_TO_BUTTON_A_OFF,
	LCD_ICON__SWAP_TO_BUTTON_A_ON,
	LCD_ICON__SWAP_TO_BUTTON_B_OFF,
	LCD_ICON__SWAP_TO_BUTTON_B_ON,
	LCD_ICON__END
};
